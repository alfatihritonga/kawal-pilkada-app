...
<p class="mb-4 text-gray-500">Halaman Untuk Mengelola Data Kelurahan / Desa</p>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Data Kelurahan / Desa</h6>
    </div>
    <div class="card-body">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addModalLabel">Tambah Data Kelurahan / Desa</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('kelurahan-desa.store') }}" method="POST" id="addForm">
                            @csrf
                            <div class="form-group">
                                <label for="nama" class="font-weight">Nama Kelurahan / Desa</label>
                            ...
                            <div class="form-group">
                                <label for="kecamatan" class="font-weight">Pilih Kabupaten / Kota</label>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel">Edit Data Kelurahan / Desa</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('kelurahan-desa.data') }}",
            columns: [
    ...
    function editData(button) {
        ...
        $('#editModal').find('form').attr('action', '{{ route('kelurahan-desa.update', ':id') }}'.replace(':id', id));
